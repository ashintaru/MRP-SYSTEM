            ...
            <div class="py-6 px-6 lg:px-8">
                ...
                <form class="space-y-6">
                        ...
                        focus:text-gray-700 focus:bg-white border-blue-600 focus:outline-none"  aria-label="Default select example" name="type" required>
                            ...
                            @else
                                ...
                                @foreach($materials as $mat)
                                    <option value="{{$mat['materialId']}}" selected="select">{{$mat['materialCode'].' '.'-'.' '.$mat["materialDetailed"]}}</option>
                                @endforeach
                            @endif
                        </select>
                    ...
                    <div>
                        ...
                        @else
                            @if($material!=null)
                                @foreach($lotsize as $key)
                                    @if($key['materialId']==$material)
                                        <p class="text-sm text-red-500">The Material Lot Size is  {{$key['vendorLotSize']}}</p>
                                    @endif
                                @endforeach
                            @endif
                       @endif
