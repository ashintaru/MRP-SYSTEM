    ...
    <div class="relative p-4 w-full max-w-md h-full md:h-auto">
        ...
        <div class="relative bg-white rounded-lg shadow dark:bg-gray-700">
            ...
            <div class="py-6 px-6 lg:px-8">
                <h3 class="mb-4 text-xl font-medium text-gray-900 dark:text-white"> <i class="fa fa-plus-square-o" aria-hidden="true"></i> Create Form</h3>
                <form class="space-y-6">   
                    <div>
                        <label for="model" wire:model="newQ" class="block mb-2 text-sm font-medium text-gray-900 dark:text-gray-300">Model Code</label>
                        <input type="text" wire:model="modelC" id="model" class="inputBox text-center bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500" min="0" max="100000" required>
                        @error('modelC')<span class="text-red-600">{{$message}}</span>@enderror
                    </div>                     
                    <div>
                        <label for="model" wire:model="newQ" class="block mb-2 text-sm font-medium text-gray-900 dark:text-gray-300">Nodel Name</label>
                        <input type="text" wire:model="model" id="model" class="inputBox text-center bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500" min="0" max="100000" required>
                        @error('model')<span class="text-red-600">{{$message}}</span>@enderror
                    </div>
                    <div>
                        <button type="submit" wire:click.prevent="submit()"  class="w-full text-white bg-blue-700 hover:bg-blue-800 focus:ring-4 focus:outline-none focus:ring-blue-300 font-medium rounded-lg text-sm px-5 py-2.5 text-center dark:bg-blue-600 dark:hover:bg-blue-700 dark:focus:ring-blue-800"> 
