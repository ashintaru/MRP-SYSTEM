            ...
            <div  class="flex flex-row justify-around p-5">
                <div class="w-1/2 md:w-full text-gray-700 dark:text-gray-200 space-y-5" >
                    <div class="inline-flex items-center py-2 px-4 text-sm font-medium text-center text-gray-900 bg-white rounded-lg border border-gray-300 hover:bg-gray-100 focus:ring-4 focus:outline-none focus:ring-gray-200 dark:bg-gray-800 dark:text-white dark:border-gray-600 dark:hover:bg-gray-700 dark:hover:border-gray-700 dark:focus:ring-gray-700">
                        ...
                        <p class="text-lg">Master List Information</p>
                    </div>
                    <div class="p-3 py-2 px-4 text-sm font-medium text-start text-gray-900 bg-white rounded-lg border border-gray-300 hover:bg-gray-100 focus:ring-4 focus:outline-none focus:ring-gray-200 dark:bg-gray-800 dark:text-white dark:border-gray-600 dark:hover:bg-gray-700 dark:hover:border-gray-700 dark:focus:ring-gray-700">
                        <ol class="flex ml-3 whitespace-nowrap">
                            ...
                            <li class="flex-1 ml-1 whitespace-nowrap">Master List Name : {{$mname}} </li>
                ...
                <div class="overflow-y-auto p-3 py-1 text-sm text-gray-700 dark:text-gray-200 w-1/2 md:w-full space-y-5 ">
                    <div class="inline-flex items-center py-2 px-4 text-sm font-medium text-center text-gray-900 bg-white rounded-lg border border-gray-300 hover:bg-gray-100 focus:ring-4 focus:outline-none focus:ring-gray-200 dark:bg-gray-800 dark:text-white dark:border-gray-600 dark:hover:bg-gray-700 dark:hover:border-gray-700 dark:focus:ring-gray-700">                      
                        ...
                        <p class="text-lg">Listed Componnts</p>
                    </div>
                    <div class="p-3 inline-flex   md:w-full ">
                        <div class=" md:w-full justify-center overflow-y-hidden h-40 hover:overflow-y-scroll " aria-labelledby="dropdownDefault ">
                            @if(count($components) != 0)
                                @foreach($components as $a)
                                    <div class="flex py-2 px-4 text-sm font-medium text-center text-gray-900 bg-white rounded-lg border border-gray-300 hover:bg-gray-100 focus:ring-4 focus:outline-none focus:ring-gray-200 dark:bg-gray-800 dark:text-white dark:border-gray-600 dark:hover:bg-gray-700 dark:hover:border-gray-700 dark:focus:ring-gray-700 md:w-full  ">                      
                                        <ol class="flex ml-3 whitespace-nowrap justify-start">
                                            <svg aria-hidden="true" class="flex-shrink-0 w-6 h-6 ionicon text-gray-500 transition duration-75 group-hover:text-gray-900 dark:text-gray-400 dark:group-hover:text-white" viewBox="0 0 512 512"><title>Logo Dropbox</title><path d="M190.06 414l163.12-139.78a24 24 0 000-36.44L190.06 98c-15.57-13.34-39.62-2.28-39.62 18.22v279.6c0 20.5 24.05 31.56 39.62 18.18z"/></svg>
                                            <li class="flex-1 ml-1 whitespace-nowrap">{{$a->materialCode}}</li>
                                            <li class="flex-1 ml-1 whitespace-nowrap">{{$a->fixedQtty}}</li>
                                        </ol>
                                    </div>
                                @endforeach
                            @else
