<!-- Main modal -->
<div wire:ignore.self id="add-modal" name='model' tabindex="-1" aria-hidden="true" class="divmodal modal1 hidden overflow-y-auto  overflow-x-hidden fixed top-0 right-0 left-0 z-50 w-full md:inset-0 h-modal md:h-full justify-center items-center">
    <div class="relative p-4 w-full max-w-md h-full md:h-auto">
        ...
        <div class="relative bg-white rounded-lg shadow dark:bg-gray-700">
            ...
            <div class="py-6 px-6 lg:px-8">
                <h3 class="mb-4 text-xl border-t-amber-300 font-medium bg text-gray-900 dark:text-white">Intransit Form</h3>
                <form class="space-y-6">
                    ...
                    <div>
                        <button type="submit" wire:click.prevent="add"  class=" w-full text-white bg-blue-700 hover:bg-blue-800 focus:ring-4 focus:outline-none focus:ring-blue-300 font-medium rounded-lg text-sm px-5 py-2.5 text-center dark:bg-blue-600 dark:hover:bg-blue-700 dark:focus:ring-blue-800">Modify</button>
                    </div>
                </form>
            </div>
        </div>
