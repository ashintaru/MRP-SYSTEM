        ...
        <div class="relative bg-white rounded-lg shadow dark:bg-gray-700">
            ...
            <div class="py-6 px-6 lg:px-8">
                ...
                <form class="space-y-6">                        
                    <div>
                        <input type="hidden" id="modelId" wire:model="modelId">
                        <label for="model" wire:model="newQ" class="block mb-2 text-sm font-medium text-gray-900 dark:text-gray-300"> Model Name</label>
