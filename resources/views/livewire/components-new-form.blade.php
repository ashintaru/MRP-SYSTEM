        ...
        <div class="relative bg-white rounded-lg shadow dark:bg-gray-700">
            ...
            <div class="py-6 px-6 lg:px-8">
                ...
                <form class="space-y-6">
                    <div>
                        ...
                        <div>
                            @if(session()->has('notif'))
                                <p class="text-xs text-gray-400">{{session('notif')}}</p>
                            @endif
                        </div>
                    </div>
                    {{-- <div>
                    ...
                    <div>
                        <button type="submit" wire:click.prevent="save()"  class="w-full text-white bg-blue-700 hover:bg-blue-800 focus:ring-4 focus:outline-none focus:ring-blue-300 font-medium rounded-lg text-sm px-5 py-2.5 text-center dark:bg-blue-600 dark:hover:bg-blue-700 dark:focus:ring-blue-800"> 
