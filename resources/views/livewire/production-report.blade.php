        ...
        <div class="overflow-x-auto relative">
            <div class="container my-1 mx-auto px-4 md:px-6">
                ...
                <div class="my-6 flex flex-row justify-between items-center">
                    <a target="_blank" href="{{URL('production-report',['key1'=>$listId])}}" id="add" class="inline-flex text-white bg-blue-700 hover:bg-blue-800 focus:ring-4 focus:outline-none focus:ring-blue-300 font-medium rounded-lg text-sm px-5 py-2.5 text-center dark:bg-blue-600 dark:hover:bg-blue-700 dark:focus:ring-blue-800 shadow-2xl"  data-tooltip-target="tooltip-top" type="button" data-modal-toggle="create-modal">
                    ...
                    <table class="w-full overflow-y-auto">
                        <thead>
                            <tr>
                                ...
                                <th class="text-left"> Production End Date</th>
